...
{
    public class RemoveAssetFromBagListener : ChronosBaseListener
    {
        ...
        public RemoveAssetFromBagListener(ICommandBus commandBus, IQueryHandler<CoinInfoQuery, CoinInfo> handler, IQueryHandler<BagInfoQuery, BagInfo> bagHandler)
        {
        ...
        public override void EnterRemoveAssetFromBag(ChronosParser.RemoveAssetFromBagContext context)
        {
            ...
            var command = new RemoveAssetFromBagCommand(assetId, quantity)
            {
                TargetId = id
            };
            _commandBus.Send(command);
            
            base.EnterRemoveAssetFromBag(context);
        }
    }
}